...
description: ''
pubDate: '2025-09-12'
heroImage: '../../assets/desktop-b020_ds_verdincactus_gettyimages-521445872_3840x2160.jpg'
tags: ['Cloudflare', 'Vercel', '域名配置', '部署', '网站加速']
---

> 最近用Github Education白嫖了name.com的一个一年域名，一开始我按照vercel官方文档部署，发现国内无法直连。故在网上搜索一番，发现可以通过Cloudfare来解决这个问题，下面分享一下我的解决方案。
...
**参考文献：**
1. [使用Vercel免费部署上线你的前端项目，并使用Cloudfare解决 Vercel 部署网站在国内被墙的问题](https://juejin.cn/post/7383894687302434825)
2. [Vercel域名加速](https://docs.tangly1024.com/article/vercel-accelerate)
3. [enhanced-FaaS-in-China
](https://github.com/xingpingcn/enhanced-FaaS-in-China)
4. [推一下 Vercel 加速节点](https://www.yt-blog.top/9952/)